const calculateRegtangeArea = (L, l) => {
  const surface = L * L;
...
const surface1 = calculateRegtangeArea(100, 250);
const surface2 = calculateRegtangeArea(350, 200);
...
const surface3 = calculateRegtangeArea(400, 370);
