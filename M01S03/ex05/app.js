...
console.warn('Afiseaza propozitia “Am x prieteni: Larry, Steven si Carol.');
...
console.warn(
  'Afiseaza propozitia “Sunt xxx si stiu HTML si CSS.”. Nu folosi valoarea din arrayul de skills. -- MA SCUZI DAR ERA MAI FUN ASA',
);
console.log(
  'Sunt ' +
    person.name +
